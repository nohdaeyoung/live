...
const DEFAULT_PROJECTS: Product[] = [
  ...
  },
  {
    ...
    works: [
      ...
      { id: "s6", title: "2026-02-24 작업 로그: Naver 우선 종가 도입·AV/Yahoo 폭백·배포 이슈 대응", url: "https://github.com/nohdaeyoung/stockmanager/blob/gh-pages/2026-02/2026-02-24-stock-portfolio-update.md", type: "개발", order: 6 },
    ],
  },
  {
    id: "planner",
