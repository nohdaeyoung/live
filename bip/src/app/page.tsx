      ...
      <section className="w-full max-w-2xl mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
          {[
            ...
            { name: '감성디자이너', role: 'UI · 콘텐츠 담당', img: '/images/profile-designer.png' },
            { name: '감성엔지니어', role: 'AI 개발 에이전트', img: '/images/profile-ai.png' },
          ].map((m) => (
      ...
      <footer className="w-full max-w-2xl mx-auto px-4 py-12 border-t border-dashed border-border text-center space-y-3">
        ...
        <div className="flex items-center justify-center gap-3 text-[10px] text-text-muted/60">
          <div className="flex flex-col items-center">
            <a href="https://github.com/yuna-studio/yuna-openclaw" target="_blank" rel="noreferrer" className="text-[10px] text-primary hover:underline">source by 낭만코딩</a>
          </div>
          <span>·</span>
